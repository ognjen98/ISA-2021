...
@Component({
  selector: 'app-lesson-reservations',
  templateUrl: './lesson-reservations.component.html',
  styleUrls: ['./lesson-reservations.component.css']
})
export class LessonReservationsComponent implements OnInit {
  ...
  getRes(){
    this.resService.getLessonsReservations().subscribe(
      res => {
        let i = 0
        this.returnData = res;
