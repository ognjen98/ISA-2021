...
export class InhrCottageDTO extends ServiceDTO{
	...
	constructor(id:number, name: string, grade: number, price:number, streetName:string, number: string, city: string, state: string, $noGuests: number, $noRooms: number, $noBedsByRoom: number) {
